...
public class scoreDataPropertyTest {
	...
	public void test_Beat5kSET() {
		...
		assertEquals(41666, scoreData.getNowScore());
		assertEquals(3, scoreData.getBestScore());
		assertEquals(3, scoreData.getBestScoreRate());
		assertEquals(3, scoreData.getNowBestScore());
		assertEquals(3, scoreData.getScoreRate());
