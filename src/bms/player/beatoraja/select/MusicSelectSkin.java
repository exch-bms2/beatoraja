...
public class MusicSelectSkin extends Skin {
	...
	public MusicSelectSkin(Rectangle r) {
		...
		addNumber(new SkinNumber(ntr[0], 5, 0, NUMBER_FOLDER_TOTALSONGS), 0, 260, 482, 18, 18, 0, 255, 255,
		...
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_MINBPM), 0, 370, 512, 18, 18, 0, 255, 255,
				255, 255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_MAXBPM), 0, 442, 512, 18, 18, 0, 255, 255,
				255, 255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		addImage(new TextureRegion(st, 0, 790, 120, 24),0, 100, 482, 90, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0, OPTION_SONGBAR, 0, 0);
		addNumber(new SkinNumber(ntr[0], 3, 0, NUMBER_PLAYLEVEL), 0, 200, 482, 18, 18, 0, 255, 255,
				255, 255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		...
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_SCORE), 0, 200, 372, 18, 18, 0, 255, 255, 255,
		...
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_MISSCOUNT), 0, 200, 342, 18, 18, 0, 255, 255,
				255, 255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		...
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_MAXCOMBO), 0, 450, 342, 18, 18, 0, 255, 255,
				255, 255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		...
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_CLEARCOUNT), 0, 320, 312, 18, 18, 0, 255, 255,
				255, 255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		...
		addNumber(new SkinNumber(ntr[0], 10, 0, NUMBER_TOTALPLAYNOTES), 0, 430, 102, 18, 18, 0,
				255, 255, 255, 255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		...
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_DURATION), 0, 440, 598, 12, 24, 0, 255, 255,
				255, 255, 0, 0, 0, 0, 0, 0, OPTION_PANEL3, 0, 0);
		addNumber(new SkinNumber(ntr[1], ntr[2], 3, 0, NUMBER_JUDGETIMING), 0, 512, 376, 12, 24, 0, 255,255,255,255, 0, 0, 0, 0, 0, 0, OPTION_PANEL3, 0, 0);
		...
		// timer
		addNumber(new SkinNumber(ntr[0], 4, 1, NUMBER_TIME_YEAR), 0, 1028, 2, 12, 12, 0, 255, 255, 255,
				255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 2, 1, NUMBER_TIME_MONTH), 0, 1088, 2, 12, 12, 0, 255, 255, 255,
				255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 2, 1, NUMBER_TIME_DAY), 0, 1130, 2, 12, 12, 0, 255, 255, 255,
				255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 2, 1, NUMBER_TIME_HOUR), 0, 1178, 2, 12, 12, 0, 255, 255, 255,
				255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 2, 1, NUMBER_TIME_MINUTE), 0, 1214, 2, 12, 12, 0, 255, 255, 255,
				255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 2, 1, NUMBER_TIME_SECOND), 0, 1250, 2, 12, 12, 0, 255, 255, 255,
				255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
	}
