...
public class MusicSelectSkin extends Skin {
	...
	public MusicSelectSkin(Rectangle r) {
		...
		search = new Rectangle(10 * dw, 60 * dh, 400 * dw, 24 * dh);
		SkinImage back = new SkinImage(new TextureRegion(new Texture("skin/default/select.png")));
		...
		for (int i = 0; i < lamp.length; i++) {
			lamp[i] = new SkinImage(lampt[i], 0, 100);
		...
		addImage(new TextureRegion(st, 0, 816, 220, 24), 0, 95, 482, 165, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_FOLDERBAR, 0, 0);
		addNumber(new SkinNumber(ntr[0], 5, 0, NUMBER_FOLDER_TOTALSONGS), 0, 260, 482, 18, 18, 0, 255, 255, 255, 255,
				0, 0, 0, 0, 0, 0, OPTION_FOLDERBAR, 0, 0);
		// lamp/rank distribution graph
		addImage(new TextureRegion(st, 400, 648, 96, 24), 0, 36, 362, 48, 24, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_FOLDERBAR, 0, 0);
		...
		add(lampgraph);
		addImage(new TextureRegion(st, 0, 672, 96, 24), 0, 36, 322, 48, 24, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_FOLDERBAR, 0, 0);
		...
		addImage(new TextureRegion(st, 240, 600, 144, 24), 0, 100, 512, 108, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0,
				0, OPTION_7KEYSONG, 0, 0);
		addImage(new TextureRegion(st, 240, 624, 144, 24), 0, 100, 512, 108, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0,
				0, OPTION_14KEYSONG, 0, 0);
		addImage(new TextureRegion(st, 240, 648, 144, 24), 0, 100, 512, 108, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0,
				0, OPTION_9KEYSONG, 0, 0);
		addImage(new TextureRegion(st, 240, 672, 144, 24), 0, 100, 512, 108, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0,
				0, OPTION_5KEYSONG, 0, 0);
		addImage(new TextureRegion(st, 240, 696, 144, 24), 0, 100, 512, 108, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0,
				0, OPTION_10KEYSONG, 0, 0);

		addImage(new TextureRegion(st, 0, 768, 72, 24), 0, 300, 512, 60, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, 0, 0);
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_MINBPM), 0, 370, 512, 18, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0,
				0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_MAXBPM), 0, 442, 512, 18, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0,
				0, 0, 0, 0, 0);
		addImage(new TextureRegion(st, 0, 790, 120, 24), 0, 100, 482, 90, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, 0, 0);
		addNumber(new SkinNumber(ntr[0], 3, 0, NUMBER_PLAYLEVEL), 0, 200, 482, 18, 18, 0, 255, 255, 255, 255, 0, 0, 0,
				0, 0, 0, 0, 0, 0);
		addImage(new TextureRegion(st, 0, 600, 120, 24), 0, 80, 372, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, 0, 0);
		addImage(new TextureRegion(st, 0, 600, 120, 24), 0, 80, 372, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_GRADEBAR, 0, 0);
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_SCORE), 0, 200, 372, 18, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0,
				0, 0, 0, 0, 0);

		addImage(new TextureRegion(st, 0, 672, 96, 24), 0, 330, 372, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, 0, 0);
		addImage(new TextureRegion(st, 0, 672, 96, 24), 0, 330, 372, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_GRADEBAR, 0, 0);
		addImage(new TextureRegion(st, 400, 100, 72, 24), 0, 450, 372, 54, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, OPTION_1P_AAA, 0);
		addImage(new TextureRegion(st, 400, 124, 72, 24), 0, 450, 372, 54, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, OPTION_1P_AA, 0);
		addImage(new TextureRegion(st, 400, 148, 72, 24), 0, 450, 372, 54, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, OPTION_1P_A, 0);
		addImage(new TextureRegion(st, 400, 172, 72, 24), 0, 450, 372, 54, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, OPTION_1P_B, 0);
		addImage(new TextureRegion(st, 400, 196, 72, 24), 0, 450, 372, 54, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, OPTION_1P_C, 0);
		addImage(new TextureRegion(st, 400, 220, 72, 24), 0, 450, 372, 54, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, OPTION_1P_D, 0);
		addImage(new TextureRegion(st, 400, 244, 72, 24), 0, 450, 372, 54, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, OPTION_1P_E, 0);
		addImage(new TextureRegion(st, 400, 268, 72, 24), 0, 450, 372, 54, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, OPTION_1P_F, 0);
		addNumber(new SkinNumber(ntr[0], 3, 0, NUMBER_SCORE_RATE), 0, 528, 372, 18, 18, 0, 255, 255, 255, 255, 0, 0, 0,
				0, 0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 1, 0, NUMBER_SCORE_RATE_AFTERDOT), 0, 582, 372, 12, 12, 0, 255, 255, 255, 255,
				0, 0, 0, 0, 0, 0, 0, 0, 0);

		addImage(new TextureRegion(st, 0, 624, 220, 24), 0, 80, 342, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, 0, 0);
		addImage(new TextureRegion(st, 0, 624, 220, 24), 0, 80, 342, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_GRADEBAR, 0, 0);
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_MISSCOUNT), 0, 200, 342, 18, 18, 0, 255, 255, 255, 255, 0, 0, 0,
				0, 0, 0, 0, 0, 0);
		addImage(new TextureRegion(st, 0, 648, 192, 24), 0, 330, 342, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, 0, 0);
		addImage(new TextureRegion(st, 0, 648, 192, 24), 0, 330, 342, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_GRADEBAR, 0, 0);
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_MAXCOMBO), 0, 450, 342, 18, 18, 0, 255, 255, 255, 255, 0, 0, 0,
				0, 0, 0, 0, 0, 0);
		addImage(new TextureRegion(st, 0, 696, 120, 24), 0, 80, 312, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, 0, 0);
		addImage(new TextureRegion(st, 0, 696, 120, 24), 0, 80, 312, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_GRADEBAR, 0, 0);
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_CLEARCOUNT), 0, 320, 312, 18, 18, 0, 255, 255, 255, 255, 0, 0, 0,
				0, 0, 0, 0, 0, 0);
		addImage(new TextureRegion(st, 0, 720, 96, 24), 0, 200, 312, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, 0, 0);
		addImage(new TextureRegion(st, 0, 720, 96, 24), 0, 200, 312, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_GRADEBAR, 0, 0);
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_PLAYCOUNT), 0, 400, 312, 18, 18, 0, 255, 255, 255, 255, 0, 0, 0,
				0, 0, 0, 0, 0, 0);
		// play, autoplay, practice, replay button
		addImage(new TextureRegion(st, 0, 310, 15, 15), 0, 80, 450, 30, 30, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, 0, 0).setClickevent(BUTTON_PLAY);
		addImage(new TextureRegion(st, 0, 310, 15, 15), 0, 80, 450, 30, 30, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_GRADEBAR, 0, 0).setClickevent(BUTTON_PLAY);
		addImage(new TextureRegion(st, 0, 325, 15, 15), 0, 130, 450, 30, 30, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, 0, 0).setClickevent(BUTTON_AUTOPLAY);
		addImage(new TextureRegion(st, 0, 325, 15, 15), 0, 130, 450, 30, 30, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_GRADEBAR, 0, 0).setClickevent(BUTTON_AUTOPLAY);
		addImage(new TextureRegion(st, 0, 340, 15, 15), 0, 180, 450, 30, 30, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_SONGBAR, 0, 0).setClickevent(BUTTON_PRACTICE);
		addImage(new TextureRegion(st, 0, 355, 15, 15), 0, 230, 450, 30, 30, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_REPLAYDATA, 0, 0).setClickevent(BUTTON_REPLAY);
		addImage(new TextureRegion(st, 0, 370, 15, 15), 0, 280, 450, 30, 30, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_REPLAYDATA2, 0, 0).setClickevent(BUTTON_REPLAY2);
		addImage(new TextureRegion(st, 0, 385, 15, 15), 0, 330, 450, 30, 30, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_REPLAYDATA3, 0, 0).setClickevent(BUTTON_REPLAY3);
		addImage(new TextureRegion(st, 0, 400, 15, 15), 0, 380, 450, 30, 30, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_REPLAYDATA4, 0, 0).setClickevent(BUTTON_REPLAY4);

		addImage(new TextureRegion(st, 0, 720, 96, 24), 0, 60, 102, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 6, 0, NUMBER_TOTALPLAYCOUNT), 0, 160, 102, 18, 18, 0, 255, 255, 255, 255, 0,
				0, 0, 0, 0, 0, 0, 0, 0);
		addImage(new TextureRegion(st, 0, 744, 120, 24), 0, 330, 102, 100, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 10, 0, NUMBER_TOTALPLAYNOTES), 0, 430, 102, 18, 18, 0, 255, 255, 255, 255, 0,
				0, 0, 0, 0, 0, 0, 0, 0);

		SkinBar barobj = new SkinBar(0, bar, 0);
		add(barobj);
		for (int i = 0; i < 22; i++) {
			setDestination(barobj.makeBarImages(false, i), 0, 800, 720 - i * 36, 500, 36, 0, 255, 255, 255, 255, 0, 0,
					0, 0, 0, 0, 0, 0, 0);
			setDestination(barobj.makeBarImages(true, i), 0, 780, 720 - i * 36, 500, 36, 0, 255, 255, 255, 255, 0, 0,
					0, 0, 0, 0, 0, 0, 0);
		}
		setCenterBar(10);
		...
		for (int i = 0; i < 7; i++) {
			barobj.getBarlevel()[i] = new SkinNumber(ntr[0], 2, 0);
		}
		...
		addImage(new TextureRegion(st, 0, 10, 10, 251), 0, 1240, 75, 10, 570, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				0, 0, 0);
		SkinSlider seek = new SkinSlider(new TextureRegion[] { new TextureRegion(st, 0, 265, 17, 24) }, 0, 0, 2,
		...
		// option panel1
		addImage(new TextureRegion(st, 8, 0, 8, 8), 500, 0, 0, 1280, 720, 0, 128, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_PANEL1, 0, 0);
		Texture pt = new Texture("skin/default/panel.png");
		addImage(new TextureRegion(pt, 0, 0, 290, 294), 0, 50, 100, 580, 588, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_PANEL1, 0, 0);
		...
		SkinImage rc = new SkinImage(rct, 0, 0);
		...
		SkinImage gc = new SkinImage(gct, 0, 0);
		...
		SkinImage fc = new SkinImage(fct, 0, 0);
		...
		addImage(new TextureRegion(st, 8, 0, 8, 8), 500, 0, 0, 1280, 720, 0, 128, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_PANEL2, 0, 0);
		addImage(new TextureRegion(pt, 298, 0, 300, 159), 0, 50, 370, 600, 318, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0,
				0, OPTION_PANEL2, 0, 0);
		...
		addImage(new TextureRegion(st, 8, 0, 8, 8), 500, 0, 0, 1280, 720, 0, 128, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				OPTION_PANEL3, 0, 0);
		addImage(new TextureRegion(pt, 598, 0, 300, 188), 0, 50, 314, 600, 374, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0,
				0, OPTION_PANEL3, 0, 0);

		ac = new SkinImage(fct, 0, 0);
		...
		addNumber(new SkinNumber(ntr[0], 4, 0, NUMBER_DURATION), 0, 440, 598, 12, 24, 0, 255, 255, 255, 255, 0, 0, 0,
				0, 0, 0, OPTION_PANEL3, 0, 0);
		addNumber(new SkinNumber(ntr[1], ntr[2], 3, 0, NUMBER_JUDGETIMING), 0, 512, 376, 12, 24, 0, 255, 255, 255, 255,
				0, 0, 0, 0, 0, 0, OPTION_PANEL3, 0, 0);
		...
		SkinImage mode = new SkinImage(modet, 0, 0);
		mode.setReferenceID(BUTTON_MODE);
		setDestination(mode, 0, 120, 10, 108, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		add(mode);
		addImage(new TextureRegion(st, 240, 744, 144, 24), 0, 10, 10, 108, 18, 0, 128, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				0, 0, 0);
		...
		SkinImage sort = new SkinImage(sortt, 0, 0);
		sort.setReferenceID(BUTTON_SORT);
		setDestination(sort, 0, 390, 10, 108, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		add(sort);
		addImage(new TextureRegion(st, 400, 720, 96, 24), 0, 280, 10, 72, 18, 0, 128, 255, 255, 255, 0, 0, 0, 0, 0, 0,
				0, 0, 0);
		...
		SkinImage lnmode = new SkinImage(lnt, 0, 0);
		lnmode.setReferenceID(BUTTON_LNMODE);
		setDestination(lnmode, 0, 700, 10, 54, 18, 0, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0, 0, 0, 0);
		add(lnmode);
		addImage(new TextureRegion(st, 550, 672, 144, 24), 0, 540, 10, 108, 18, 0, 128, 255, 255, 255, 0, 0, 0, 0, 0,
				0, 0, 0, 0);

		// timer
		addNumber(new SkinNumber(ntr[0], 4, 1, NUMBER_TIME_YEAR), 0, 1028, 2, 12, 12, 0, 255, 255, 255, 255, 0, 0, 0,
				0, 0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 2, 1, NUMBER_TIME_MONTH), 0, 1088, 2, 12, 12, 0, 255, 255, 255, 255, 0, 0, 0,
				0, 0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 2, 1, NUMBER_TIME_DAY), 0, 1130, 2, 12, 12, 0, 255, 255, 255, 255, 0, 0, 0, 0,
				0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 2, 1, NUMBER_TIME_HOUR), 0, 1178, 2, 12, 12, 0, 255, 255, 255, 255, 0, 0, 0,
				0, 0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 2, 1, NUMBER_TIME_MINUTE), 0, 1214, 2, 12, 12, 0, 255, 255, 255, 255, 0, 0, 0,
				0, 0, 0, 0, 0, 0);
		addNumber(new SkinNumber(ntr[0], 2, 1, NUMBER_TIME_SECOND), 0, 1250, 2, 12, 12, 0, 255, 255, 255, 255, 0, 0, 0,
				0, 0, 0, 0, 0, 0);
	}
