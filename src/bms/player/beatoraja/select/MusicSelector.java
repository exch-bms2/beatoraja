...
public class MusicSelector extends ApplicationAdapter {
    ...
    private final SortComparator[] SORT = {new NameSortComparator(), new LevelSortComparator(),
            new LampSortComparator(), new MissCountSortComparator(), new ScoreSortComparator()};
    ...
    public void render() {
        ...
        for (int i = 0; i < h / barh + 2; i++) {
            ...
            if (sd instanceof SongBar) {
                ...
                titlefont.setColor(song.getDifficulty() < difficulty.length ? difficulty[song.getDifficulty()] : Color.WHITE);
...
abstract class SortComparator implements Comparator<Bar> {
...
class NameSortComparator extends SortComparator {

    public NameSortComparator() {
        setName("SONG NAME");
    }
...
class LevelSortComparator extends SortComparator {

    public LevelSortComparator() {
        setName("LEVEL");
    }
...
class ScoreSortComparator extends SortComparator {

    public ScoreSortComparator() {
        setName("SCORE RATE");
    }
...
class LampSortComparator extends SortComparator {

    public LampSortComparator() {
        setName("CLEAR LAMP");
    }
...
class MissCountSortComparator extends SortComparator {

    public MissCountSortComparator() {
        setName("MISS COUNT");
    }
