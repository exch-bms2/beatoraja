	...
	public void render() {
        ...
        for (int i = 0; i < h / barh + 2; i++) {
            ...
            if (sd instanceof GradeBar) {
                ...
                if (sd.getScore() != null && sd.getScore().getClear() != 0 && skin.getLamp()[sd.getScore().getClear()] != null) {
                    // sprite.setBlendFunction(GL11.GL_ONE, GL11.GL_ONE);
                    sprite.begin();
        ...
        if (currentsongs[selectedindex] instanceof SongBar) {
            ...
            if (currentsongs[selectedindex].getScore() != null && currentsongs[selectedindex].getScore().getClear() != 0) {
