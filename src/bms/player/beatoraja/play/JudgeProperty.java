...
public enum JudgeProperty {
    ...
    Default(new int[][]{ {-20, 20}, {-60, 60}, {-160, 140}, {-320, 240}, {-350, 650} },
            new int[][]{ {-25, 25}, {-75, 75}, {-200, 175}, {-320, 300}, {-350, 650 }},
            new int[][]{ {-160, 20}, {-200, 60}, {-260, 140}, {-320, 240}},
            new int[][]{ {-160, 25}, {-200, 75}, {-260, 175}, {-320, 300}},
            false
            ),
    PMS(new int[][]{ {-25, 25}, {-75, 75}, {-175, 175}, {-200, 200}, {-350, 650} },
            new int[][]{},
            new int[][]{ {-160, 25}, {-200, 75}, {-260, 175}, {-320, 200}},
            new int[][]{},
            true
            );
