...
public enum GaugeProperty {
    ...
    public enum GaugeElementProperty {
        ...
        NORMAL_KB(0 ,2, 100, 20, 70, new float[]{1.0f, 1.0f, 0.5f, -2.0f, -6.0f, -2.0f}, new float[][]{}),
        HARD_KB(1 ,0 ,100 ,100, 0, new float[]{0.15f, 0.12f, 0.03f, -5.0f, -10.0f, -5.0f}, new float[][]{{10, 0.4f},{20, 0.5f},{30, 0.6f},{40, 0.7f},{50, 0.8f}}),
        EXHARD_KB(2 ,0 ,100 ,100, 0, new float[]{0.15f, 0.06f, 0, -10.0f, -15.0f, -10.0f}, new float[][]{}),
        HAZARD_KB(1 ,0 ,100 ,100, 0, new float[]{0.15f, 0.06f, 0, -100.0f, -100.0f, -100.0f}, new float[][]{}),
        CLASS_KB(1 ,0 ,100 ,100, 0, new float[]{0.15f, 0.12f, 0.06f, -1.5f, -3f, -1.5f}, new float[][]{{5, 0.4f},{10, 0.5f},{15, 0.6f},{20, 0.7f},{25, 0.8f}}),
        EXCLASS_KB(1 ,0 ,100 ,100, 0, new float[]{0.15f, 0.12f, 0.03f, -3.0f, -6.0f, -3.0f}, new float[][]{}),
        EXHARDCLASS_KB(1 ,0 ,100 ,100, 0, new float[]{0.15f, 0.06f, 0, -5.0f, -10.0f, -5.0f}, new float[][]{}),
        ;
