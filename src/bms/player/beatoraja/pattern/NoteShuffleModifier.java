...
public class NoteShuffleModifier extends PatternModifier {
	...
	// TODO 現在は7to9のみでの使用。7to9はModeModifierに移動し、NewNoteShuffleModifier->NoteShuffleModifierに変更
	...
	public NoteShuffleModifier(PlayerConfig config) {
		super(1);
		this.config = config;
	}
	...
	//7to9
	private int[] sevenToNine(int[] keys, int[] activeln, Note[] notes, int[] lastNoteTime, int now, int duration) {
		/**
